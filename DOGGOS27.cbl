      ...
      * INTERNAL ACCUMULATOR FOR EACH BREED                                     
       01 BREED-INDEXES.                                                        
           ...
           05 STAFFY-INDEX.                                                     
               10 STAFFY-INDEX-VALUE PIC 9(1) VALUE 9.                          
               10 STAFFY-BREED-NAME PIC X(6) VALUE 'STAFFY'.                    
           05 OTHER-INDEX.                                                      
               10 OTHER-INDEX-VALUE  PIC 9(2) VALUE 10.                         
               10 OTHER-BREED-NAME PIC X(5) VALUE 'OTHER'.                      
      * INTERNAL DATA STRUCTURE TO KEEP THE AMOUNT OF ADOPTIONS                 
      * PER BREED                                                               
       01 ACCUMULATOR.                                                          
           05 BREED-ADOPTIONS PIC 9(3) OCCURS 10 TIMES VALUE 000.               
      ...
      * WRITE EACH BREED RESULTS INTO THE FINAL REPORT                          
           ...
           MOVE STAFFY-BREED-NAME TO DOG-BREED.                                 
           MOVE BREED-ADOPTIONS(STAFFY-INDEX-VALUE) TO ADOPTED-AMOUNT.          
           MOVE ADOPTED-RESULT TO ADOPTED-REPORT-REC.                           
           PERFORM WRITE-ADOPTION-BREED-REPORT.                                 
      ...
      * WHEN PARTICULAR DOG BREED COMES - UPDATE THE ACCUMULATOR FOR IT         
           EVALUATE INP-DOG-BREED                                               
                ...
                WHEN STAFFY-BREED-NAME                                          
                ADD INP-ADOPTED-AMOUNT                                          
                    TO BREED-ADOPTIONS(STAFFY-INDEX-VALUE)                      
                WHEN OTHER                                                      
                ADD INP-ADOPTED-AMOUNT                                          
